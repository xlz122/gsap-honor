  ...
  return (
    <>
      ...
      <SectionConnect
        ...
        videoURL={'/src/assets/images/section-connect/connect-01.mp4'}
      />
      <SectionConnect
        title={['跨设备接续', '思路畅通无阻']}
        intro={[
        ...
        videoURL={'/src/assets/images/section-connect/connect-02.mp4'}
      />
      <SectionConnect
        title={['一套键鼠', '多设备自成一套']}
        intro={[
        ...
        videoURL={'/src/assets/images/section-connect/connect-03.mp4'}
      />
      <SectionNotice />
      <SectionDevice />
      <SectionNote />
