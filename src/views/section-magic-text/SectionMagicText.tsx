...
function SectionMagicText(): React.ReactElement {
  ...
  useGSAP(() => {
    ...
    gsap.to('.section-magic-text .card-blur1 .card-content', {
      scrollTrigger: {
        trigger: '.section-magic-text',
        start: 'top 65px',
        end: 'center 100%',
    ...
    gsap.to('.section-magic-text .card-blur2 .card-content', {
      scrollTrigger: {
        trigger: '.section-magic-text',
        start: 'top -100%',
        end: 'bottom bottom',
    ...
    <section className="section-magic-text">
      <div className="section-wrapper">
        ...
        <div className="sticky-content" ref={stickyContentRef}>
          ...
          <div className="card card-blur card-blur1">
            <div className="card-content">
              <div className="cover-info">
          ...
          <div className="card card-blur card-blur2">
            <div className="card-content">
              <div className="cover-info">
